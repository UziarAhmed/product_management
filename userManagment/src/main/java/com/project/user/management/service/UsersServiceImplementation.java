...
public class UsersServiceImplementation implements UsersService {
    ...
    public UsersResponseDto updateUser(UsersUpdateRequestDto userDto) {
        ...
        if (userDto.getPassword() != null && !((String) userDto.getPassword()).isBlank()) {
            existingUser.setPassword(passwordEncoder.encode((@Nullable CharSequence) userDto.getPassword()));
        }
